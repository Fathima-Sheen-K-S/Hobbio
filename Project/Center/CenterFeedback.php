...
if(isset($_POST["btnsubmit"])){
	...
	$insqry="insert into tbl_feedback(feedback_content,feedback_time,center_id) values('".$fcontent."',curtime(),".$centerid.")";
	if($con->query($insqry))
	{
		?>
    <script>
  document.addEventListener("DOMContentLoaded", function() {
    Swal.fire({
      ...
      window.location = "CenterFeedback.php";
    });
  });
</script>
      <?php
...
<title>Hobbio::Center Feedback</title>
</head>
...
<form id="form1" name="form1" method="post" action="" style="background-color: #fff;
  ...
  <table width="409" rules="none" cellspacing="30" cellpadding="30" style=" width: 600px;
    ...
    border-radius: 5px;" required placeholder="Enter Your Feedback"></textarea></td>
    </tr>
