...
<center>
    <h2 style="font-family: 'Times New Roman', serif; font-size: 35px;">General Report Of Users</h2>
</center>
<form id="form1" name="form1" method="post" action=""  style="background-color: #fff;
  ...
  <table  rules="none"  cellpadding="10" align="center" style="width: 100%;
    ...
    <tr>
      <td colspan="4" align="center"><input type="submit" name="btnsave" id="btnsave" value="View Results" 
...
<form  style="background-color: #fff;
  ...
  <table  border="1" cellpadding="10" align="center" style="width: 100%;
            border: 1px solid #ccc;">
    <tr>
      <td width="41" align="center" style=" padding: 8px;">Sl.no</td>
      <td width="46" align="center" style=" padding: 8px;">Name</td>
      <td width="60" align="center" style=" padding: 8px;">Contact</td>
      <td width="97" align="center" style=" padding: 8px;">Email</td>
      
     
     
    </tr>
    <?php
	$sel="SELECT * FROM tbl_booking b inner join tbl_user u on b.user_id=u.user_id where b.booking_status='1' and b.booking_date between '".$_POST["txt_f"]."' and '".$_POST["txt_t"]."'";
	$row=$con->query($sel);
	$i=0;
    ...
    <tr>
      ...
      <td align="center" style=" padding: 8px;"><?php echo $data["user_name"];?></td>
      <td align="center" style=" padding: 8px;"><?php echo $data["user_contact"];?></td>
      <td align="center" style=" padding: 8px;"><?php echo $data["user_email"];?></td>
