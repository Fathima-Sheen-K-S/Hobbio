...
$centerid=$_SESSION['cenid'];

if(isset($_POST["btnsubmit"])){
	$comtitle=$_POST["txtcomtitle"];
	$comcontent=$_POST["txtcomcontent"];
	$insqry="insert into tbl_centercomplaint(ccomplaint_title,ccomplaint_content,user_id,center_id) values('".$comtitle."','".$comcontent."',".$userid.",".$centerid.")";
	if($con->query($insqry))
	{
		?>
    <script>
  document.addEventListener("DOMContentLoaded", function() {
    Swal.fire({
      ...
      window.location = "ComplaintToCenters.php";
    });
  });
</script>
      <?php
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
    Swal.fire({
      ...
      text: "Failed to submit your complaint. Please try again.",
      icon: "error"
    }).then(() => {
      window.location = "ComplaintToCenters.php";
    });
...
<title>Hobbio::Complaint To Centers</title>
...
<form id="form1" name="form1" method="post" action="" style="background-color: #fff;
  ...
  <table  rules="none" cellspacing="30" cellpadding="30" style=" width: 600px;
    ...
    <tr>
      ...
      <td width="186" style='font-size: 15px; font-family: "Playfair Display", serif;'><label for="txtcomtitle"></label>
...
<td align="center" style='font-size: 20px; font-family: "Playfair Display", serif;'>Center Name</td>
...
<td align="center" style='font-size: 20px; font-family: "Playfair Display", serif;'>Center Reply:</td>
</tr>
<?php
$selc="SELECT * FROM tbl_centercomplaint c inner join tbl_center ce on ce.center_id=c.center_id where user_id=".$userid;
 $resc=$con->query($selc);
   $i=0;
...
?>
<tr>
       <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $i;?></td>
       <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['center_name'];?></td>
       <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['ccomplaint_title'];?></td>
        <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['ccomplaint_content'];?></td>
          <?php
		if($rowc['ccomplaint_status']==1)
		{
			?>
            <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['ccomplaint_reply'];?></td>
            <?php
		}
		else
		{
			?>
            <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'>Waiting...</td>
            <?php
		}
		?>
         </tr>
