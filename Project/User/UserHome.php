			...
			?>
				<div class="classes-item">
					...
					<div class="ci-bottom">
						...
						<a href="SearchCenters.php" class="site-btn sb-gradient">View</a>
					</div>
				</div>
				<?php
			}
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"  style="color:#f65d5f;" fill="currentColor" class="bi bi-balloon-heart" viewBox="0 0 16 16">
