...
<title>Hobbio::User Complaint</title>
</head>
...
<form id="form1" name="form1" method="post" action="" style="background-color: #fff;
  ...
  <table  rules="none" cellspacing="30" cellpadding="30" style=" width: 600px;
    ...
    border-radius: 5px;" required placeholder="Enter Complaint Title Here" autocomplete="off"/></td>
    </tr>
    <tr>
...
<tr>
       ...
       <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['complaint_title'];?></td>
        <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['complaint_content'];?></td>
          <?php
		if($rowc['complaint_status']==1)
		{
			?>
            <td align="center" style='font-size: 17px; font-family: "Playfair Display", serif;'><?php echo $rowc['complaint_reply'];?></td>
            <?php
		}
		else
		{
